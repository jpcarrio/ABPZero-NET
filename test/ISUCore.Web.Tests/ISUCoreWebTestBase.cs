...
using ISUCore.Models.TokenAuth;
...
{
    public abstract class ISUCoreWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ISUCoreWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ISUCoreWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ISUCoreDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ISUCoreDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ISUCoreDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ISUCoreDbContext, Task<T>> func)
        {
            T result;
