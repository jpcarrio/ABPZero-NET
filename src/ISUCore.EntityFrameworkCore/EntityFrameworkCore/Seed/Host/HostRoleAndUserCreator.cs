...
namespace ISUCore.EntityFrameworkCore.Seed.Host
{
    public class HostRoleAndUserCreator
    {
        ...
        public HostRoleAndUserCreator(ISUCoreDbContext context)
        {
            _context = context;
        }
        ...
        private void CreateHostRoleAndUsers()
        {
            ...
            {
                var email = $"{userName}@{ISUCoreConsts.mailService}.com";
                ...
                adminUser.Password = new PasswordHasher<User>(new OptionsWrapper<PasswordHasherOptions>(new PasswordHasherOptions())).HashPassword(adminUser, ISUCoreConsts.DefaultPassword);
            ...
            // ApiUser for host
            //
            var apiClientName = ISUCoreConsts.DefaultApiUserName;
            var apiClientUserForHost = _context.Users.IgnoreQueryFilters().FirstOrDefault(u => u.TenantId == null && u.UserName == ISUCoreConsts.DefaultApiUserName);
            if (apiClientUserForHost == null)
            {
                var email = $"{apiClientName}@{ISUCoreConsts.mailService}.com";
                ...
                apiClientUser.Password = new PasswordHasher<User>(new OptionsWrapper<PasswordHasherOptions>(new PasswordHasherOptions())).HashPassword(apiClientUser, ISUCoreConsts.DefaultPassword);
